package read_write_binary_file;
...
//        InputStream is = new FileInputStream("src/read_write_binary_file/CodeGym.txt");
//
//        int i = -1;
//
...
//        is.close();
        ...
        InputStream in = new FileInputStream("src/read_write_binary_file/CodeGym.txt");
